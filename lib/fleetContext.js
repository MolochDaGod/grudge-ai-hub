...
import { PLAY_CONTRACT } from './playContract.js';
...
export const ONE_TRUTH = {
  ...
  asset_serve: {
    ...
    not_play_default: 'models/grudge6 bake kits (*_Characters.glb), raw FBX, metaverse stubs, Meshy, capsule, split gltf without bin',
    mime: {
...
export function buildContextPack() {
  return {
    ...
    load_order_for_agents: [
      ...
      '7. Play mesh / skeleton / clips / UUID → GET /v1/play-contract (one Warlords system)',
    ],
    anti_patterns: [
      ...
      'models/grudge6 bake kits as play mesh',
      'Deploying workers/ale as a second ai.grudge-studio.com brain',
      'Minting a second account UUID besides Grudge ID',
    ],
  };
}
...
- Play contract: GET /v1/play-contract — Bip001 + Toon RTS kit + prod/anims + Grudge UUID. Dual-worker deploy both Legion workers.
- UUID: GET /v1/uuid?family=character|item&slot=sword — Grudge-Builder generateGrudgeUUID. Account ids stay Grudge ID.
...
export { PLAY_CONTRACT, mintUuid } from './playContract.js';
